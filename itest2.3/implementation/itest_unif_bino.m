function [H, prob, stat] = itest_unif_bino(SD,N_trial,Pcm,g_0,alpha,precision,skip_preparation)
...
%
% [H, prob, stat] = itest_unif_bino(SD,N_trial,Pcm,g_0,alpha,precision,skip_preparation)
%
